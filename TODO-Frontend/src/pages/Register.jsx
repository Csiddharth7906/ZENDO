    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            <a
              href="https://zendo-1.onrender.com/api/auth/google"
          ...
          <div className="mt-8 text-center">
            ...
            <Link 
              to="/login" 
              className="w-full inline-flex justify-center py-3 px-4 border-2 border-gray-300 rounded-xl text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-all duration-200"
            >
              Log in
            </Link>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-red-400 to-orange-400 items-center justify-center p-12">
        <div className="text-center text-white">
          ...
          <h2 className="text-3xl font-bold mb-4">Join millions of people</h2>
          <p className="text-lg opacity-90">who organize work and life with Zendo.</p>
        </div>
      </div>
    </div>
  );
